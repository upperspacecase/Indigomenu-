...
function MenuItem({ pt, en, desc, descEn, price }: Item) {
  return (
    ...
    <main className="page">
      ...
      <Accordion>
        <AccordionItem id="breakfast" icon={<SunIcon />} title="Pequeno-Almoço | Breakfast">
          <h3>Rituais de Amanhecer | Sunrise Rituals</h3>
          <p className="menu-note">10:00 — 13:00</p>
          ...
          <MenuItem pt="Brunch Indigo" en="Indigo Brunch"
            ...
            price="€ 14.00 / € 22.00 (2 pax)" />

          <h3>Sobremesas | Sweet Ending</h3>
          ...
          <h3>Gelados Soft e Bowls | Soft Serve & Bowls</h3>
        ...
        <AccordionItem id="food" icon={<ForkKnifeIcon />} title="Comida | Food">
          <h3>Aperitivos do Atlântico | Atlantic Appetizers</h3>
          ...
          <h3>Entre Pães | Lizandro Bread Bites</h3>
          ...
          <h3>Petiscos para Partilhar | Petiscos to Share</h3>
          ...
          <h3>Ondas do Mar | Ocean Vitality</h3>
          ...
          <h3>Chef Corner Paelhas | Chef Corner Paellas</h3>
          <p className="menu-note">A ritualística da confeção lenta para partilhar à mesa (30 minutos · 2 pax)</p>
          ...
          <h3>Grelhados | The Fire Kitchen (Grill)</h3>
        ...
        <AccordionItem id="drinks" icon={<CocktailIcon />} title="Bebidas | Drinks">
          ...
          <h3>Refrigerantes | Soft Drinks</h3>
          ...
          <h3>Batidos | Milkshakes</h3>
          <p className="menu-note">Opção de leite de amêndoa ou leite de aveia disponível · Almond milk or oat milk option available</p>
          ...
          <h3>Sangrias</h3>
          <p className="menu-note">Com duas bases para escolher · With two bases to choose from</p>
          ...
          <h3>Cocktails — Rota clássica | Classic route</h3>
          ...
          <h3>Cocktails de Assinatura | Signature Cocktails</h3>
          ...
          <h3>Espirituosas | Fine Spirits</h3>
        ...
        <AccordionItem id="wine" icon={<WineIcon />} title="Carta de Vinhos | Wine List">
          <h3>Vinhos Brancos | White Wines</h3>
          <h4>Lisboa</h4>
          ...
          <h3>Espumantes | Sparkling Wines</h3>
          ...
          <h3>Vinhos Naturais | Natural Wines</h3>
      ...
      <Accordion>
        <AccordionItem id="group" icon={<GroupIcon />} title="Menus de Grupo | Group Menus">
          ...
          <h3>Menu € 30</h3>
          <p className="menu-note">Entradas é 1 para 3 pessoas · Starters serve 3</p>
          <h4>Couvert</h4>
          ...
          <h3>Aditivos de Bebidas | Beverage Additives</h3>
          <p className="menu-note">Apenas durante o serviço de jantar (aprox. 2h) · Only during dinner service (approx. 2h)</p>
      ...
      <Accordion>
        ...
        <AccordionItem id="contact" icon={<PhoneIcon />} title="Contacte-nos | Contact Us" subtitle="Indigo Beach Club">
          <p className="menu-note">Contacte-nos diretamente pelo Instagram ou através da página de localização do Google.</p>
          <p className="menu-note"><em>Reach out via Instagram or our Google location page.</em></p>
        </AccordionItem>
